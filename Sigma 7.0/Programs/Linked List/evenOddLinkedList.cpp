...
Node* evenOddLL(Node* head){
    Node* evenPtr = NULL, * oddPtr = NULL;
    Node* evenPtrNext = NULL, * oddPtrNext = NULL;
    Node* evenHead = NULL, * oddHead = NULL;
    Node* ptr = head;

    while(ptr != NULL){
        if((ptr->data)%2 == 0){     //even
            evenPtrNext = ptr;
            ptr = ptr->next;
            evenPtrNext->next = NULL;
            if(evenPtr!=NULL){
                evenPtr->next = evenPtrNext;
                evenPtr = evenPtrNext;
            }else{
                evenPtr = evenPtrNext;
                evenHead = evenPtr;
            ...
            oddPtrNext = ptr;
            ptr = ptr->next;
            oddPtrNext->next = NULL;
            if(oddPtr!=NULL){
                oddPtr->next = oddPtrNext;
                oddPtr = oddPtrNext;
            }else{
                oddPtr = oddPtrNext;
                oddHead = oddPtr;
